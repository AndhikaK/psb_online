...
<body>
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <!-- ========================== ADD content here ================================ -->
            <h2 class="mb-4">Detail Calon Siswa</h2>
            <div>
                <input type="button" class="btn btn-sm mb-2 btn-success" value="print" onclick="PrintDiv(<?= $data['id'] ?>);" />
            </div>
    ...
    <script src="../../assets/js/my-main.js"></script>
